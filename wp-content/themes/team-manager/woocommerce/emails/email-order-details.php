...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			...
			<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;">Netto</th>
			<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;">Mwst</th>
			<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;"><?php _e( 'Total', 'woocommerce' ); ?></th>
		</tr>
	</thead>
	<tbody>
